                    ...
                    <div class="col-lg-12 text-center">
                        ...
                        ?>
                                ...
                                <tbody>
								 ...
								 {
								?>
                                    <tr style="height:50px; <?php if($val->prospective_status == "A"){ echo "color: #4F8A10; background-color: #DFF2BF;"; } else if($val->prospective_status == "P") { echo "color: #4F2F4F; background-color: #CDC1C5;"; }else { echo "color: #ff1919; background-color: #ffcccc;"; } ?>;" >
                                        <td><?php echo $num; ?></td>
