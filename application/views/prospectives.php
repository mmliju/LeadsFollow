               ...
               <div class="row">
                    ...
                    <div class="col-lg-2 text-center">
                        <div class="panel panel-default">
                                 <div class="form-group">
                            		...
                            		<input class="form-control" placeholder="Start Date" name="from_date" value="<?php if(isset($from_date)){ echo $from_date;} ?>" >
                                    <span class="add-on">
                    ...
                    <div class="col-lg-2 text-center">
                                 <div class="form-group">
                            		...
                            		<input class="form-control" placeholder="End Date" name="to_date" value="<?php if(isset($to_date)){ echo $to_date;} ?>" >
                                    <span class="add-on">
                                        <i data-time-icon="icon-time" data-date-icon="icon-calendar"></i>
                                      </span></div>
                            </div>
