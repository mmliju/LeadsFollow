                 ...
                 <!------------------------------------------------------------------------------------------->
                  ...
                  <div class="col-lg-6">
                        ...
                        <ul class="list-group">
							 ...
							 {
							?>
                            <li class="list-group-item">Subject: <?php echo $details->subject; ?><br/>Content:  <?php echo $details->body; ?>
                             Attachment <a href="http://aidansoic.com/OIC/attahments/<?php echo $details->email_attachment;  ?>"><?php echo $details->email_attachment; ?></a></li>
                            </li>
                            <?php
							}
							?>
                      ...
                      <!-------------------------------------------------------------------->
                        ...
                        <ul class="list-group">
                           <?php
                            ...
                            File <a href="http://aidansoic.com/OIC/quotations/<?php echo $qdetails->file;  ?>"><?php echo $qdetails->file; ?></a><br/><br/>
                           <strong> Quatation Status:  <?php echo $qdetails->quote_status; ?></strong><br/>
                            </li>
                            <?php
							}
							?>
                           ...
                           <li class="list-group-item"><a href="<?php echo base_url(); ?>index.php/prospectives/add_quote/<?php if(isset($prospective_id)){ echo $prospective_id; } ?>">New Quatation</a></li>
                    ...
                    <div class="modal-body">
                         <div class="row">
                                ...
                                $attributes = array('class' => 'send_email');
                                 echo form_open_multipart('prospectives/send_reminder', $attributes);
                              ?>
                       		 <ul class="list-group">
                             ...
                             <li class="list-group-item"><input  type="text" name="subject" placeholder="Subject" value="" /></li>
                               <li class="list-group-item"><input  type="file" name="email_attachment" placeholder="File" value="" /></li>
